export const GameABI = [
		...
		"inputs": [
			{
				...
				"name": "_currentChainSelectorIndex",
				"type": "uint256"
			}
		],
	...
	},
	{
		...
		"inputs": [
			...
			},
			{
				...
				"indexed": false,
				"internalType": "struct ZKGameClient.MessageItem",
				"name": "messageItem",
				"type": "tuple"
			}
		],
	...
	{
		"inputs": [],
		"name": "currentChainSelectorIndex",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
	...
	{
		"inputs": [],
		"name": "getPlayerLastLotteryRequestStatus",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "paid",
	...
	},
	{
		...
		"name": "playerLastlotteryRequestIdMap",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
