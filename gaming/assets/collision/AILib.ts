...
export const obbIntersect = function (centerA: any, halfA: any, rotA: any, centerB: any, halfB: any, rotB: any) {
       ...
       let ae0 = halfA.x, ae1 = halfA.y, ae2 = halfA.z, ma = rotA.m,
              au00 = ma[0], au01 = ma[1], au02 = ma[2],
              au10 = ma[3], au11 = ma[4], au12 = ma[5],
              au20 = ma[6], au21 = ma[7], au22 = ma[8];

       let be0 = halfB.x, be1 = halfB.y, be2 = halfB.z, mb = rotB.m,
              bu00 = mb[0], bu01 = mb[1], bu02 = mb[2],
              bu10 = mb[3], bu11 = mb[4], bu12 = mb[5],
              bu20 = mb[6], bu21 = mb[7], bu22 = mb[8];
 ...
 * @zh 测试线段与线段是否相交
 */
function lineLine (a1: Readonly<cc.Vec2>, a2: Readonly<cc.Vec2>, b1: Readonly<cc.Vec2>, b2: cc.Vec2): boolean {
   ...
   const tempR1 = new cc.Vec2();
   const tempR2 = new cc.Vec2();
   const tempR3 = new cc.Vec2();
   const tempR4 = new cc.Vec2();
   
   /**
    * @en Test line and rect
    * @zh 测试线段与矩形是否相交
    */
   function lineRect (a1: Readonly<cc.Vec2>, a2: Readonly<cc.Vec2>, b: cc.Rect): boolean {
       ...
       r0.x = b.x,r0.y = b.y;
       r1.x = b.x,r1.y = b.yMax;
       r2.x = b.xMax,r2.y = b.yMax;
       r3.x = b.xMax,r3.y = b.y;   
    ...
    * @zh 测试线段与多边形是否相交
    */
   function linePolygon (a1: Readonly<cc.Vec2>, a2: Readonly<cc.Vec2>, b: readonly cc.Vec2[]): boolean {
    ...
    * @zh 测试矩形与矩形是否相交
    */
   function rectRect (a: cc.Rect, b: cc.Rect): boolean {
       // jshint camelcase:false
    ...
    * @zh 测试矩形与多边形是否相交
    */
   function rectPolygon (a: Readonly<cc.Rect>, b: readonly cc.Vec2[]): boolean {
       ...
       r0.x = a.x,r0.y = a.y;
       r1.x = a.x,r1.y = a.yMax;
       r2.x = a.xMax,r2.y = a.yMax;
       r3.x = a.xMax,r3.y = a.y; 
    ...
    * @zh 测试多边形与多边形是否相交
    */
   function polygonPolygon (a: readonly cc.Vec2[], b: readonly cc.Vec2[]): boolean {
       let i; let l;
    ...
    * @zh 测试圆形与圆形是否相交
    */
   function circleCircle (c1p: Readonly<cc.Vec2>, c1r: number, c2p: Readonly<cc.Vec2>, c2r: number): boolean {
       const distance = cc.Vec2.distance(c1p, c2p);
    ...
    * @zh 测试多边形与圆形是否相交
    */
   function polygonCircle (polygon: readonly cc.Vec2[], cp: Readonly<cc.Vec2>, cr: number): boolean {
       const position = cp;
    ...
    * @zh 测试矩形与圆形是否相交
    */
   function rectCircle (rect: cc.Rect, cp: Readonly<cc.Vec2>, cr: number): boolean {
       const cx = cp.x;
       const cy = cp.y;
    ...
    * @zh 测试一个点是否在一个多边形中
    */
   function pointInPolygon (point: Readonly<cc.Vec2>, polygon: readonly cc.Vec2[]): boolean {
       let inside = false;
       const x = point.x;
       const y = point.y;
    ...
    */
   function pointLineDistance (point: Readonly<cc.Vec2>, start: Readonly<cc.Vec2>, end: Readonly<cc.Vec2>, isSegment: boolean): number {
